...
def is_fingerprint_match(matched_minutiae, total_minutiae1, total_minutiae2, match_threshold=0.3):
    ...
    match_percentage1 = match_ratio1 * 100
    match_percentage2 = match_ratio2 * 100
    print(f"Match percentage (image1): {match_percentage1:.2f}%")
    print(f"Match percentage (image2): {match_percentage2:.2f}%")
...
image1 = cv2.imread("C:/Users/inez/Downloads/Fingerprint-Matching (minutiae) 2/Fingerprint-Matching (minutiae)/output/1.png")
image2 = cv2.imread("C:/Users/inez/Downloads/Fingerprint-Matching (minutiae) 2/Fingerprint-Matching (minutiae)/output/1.png")
